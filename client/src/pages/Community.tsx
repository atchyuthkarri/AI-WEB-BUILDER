        ...
        <div className='py-10 min-h-[80vh]'>
          ...
          <div className='flex flex-wrap gap-3.5'>
            {projects.map((project)=>(
              <Link key={project.id} to={`/view/${project.id}`} target='_blank' className='w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 round-lg overflow-hidden group hover:border-indigo-800/80 transition-all duration-300'>
