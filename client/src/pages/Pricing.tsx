  ...
  return (
    ...
    <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
      <div className='text-center mt-16'>
        <h2 className='text-gray-100 text-3xl font-medium'>Pick Your Plan</h2>
        <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Begin for free and scale with confidence. Discover the plan designed for your content creation journey.</p>
      </div>
      ...
      <div className='pt-14 py-4 px-4 '>
        <div className='grid grid-cols-1 md:grid-cols-3 flex-wrap gap-4'>
                ...
                <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Project <span className='text-white'>Creation / Revision <span className='text-white' >consume</span> 5 credits</span>. You can purchase more credits to create more projects.</p>
    </div>
    <Footer/>
    </>
  )
