    ...
    <>
        ...
        <Link to="/">
          ...
          <div className="flex items-center gap-3">
            <button className="px-6 py-1.5 bg-indigo-600 max-sm:text-sm bg-indigo-600 active:scale-95 hover:bg-indigo-700 transition rounded" onClick={()=>navigate("/auth/signin")}>
              Get started
            </button>
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-[100] bg-black/60 text-white backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300">
            ...
            <Link to="/myprojects" onClick={() => setMenuOpen(false)}>My Projects</Link>
